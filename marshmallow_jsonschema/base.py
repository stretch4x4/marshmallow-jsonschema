...
class JSONSchema(Schema):
    ...
    def _get_enum_values(self, field) -> list[str]:
        assert ALLOW_ENUMS and isinstance(field, EnumField)  # ruff: noqa: S101, asserts will be removed in open PR
    ...
    def _from_union_schema(self, obj, field) -> dict[str, list[typing.Any]]:
        ...
        assert ALLOW_UNIONS and isinstance(field, Union)  # ruff: noqa: S101, asserts will be removed in open PR
